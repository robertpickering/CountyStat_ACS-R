...
medianincom2011b2014 = t(data.frame(estimate(benchmarks2014[[8]])))


#combine all into one list
medianincom2011b <- list("2011" = medianincom2011b2011, 
                         "2013" = medianincom2011b2013, 
                         "2014" = medianincom2011b2014)
...
write.csv(medianincom2011b$`2014`, file = "medianincom2011b2014.csv")
medianincom2011b2014 <- data.frame(read.csv("medianincom2011b2014.csv"))
headers <- colnames(medianincom2011b2014)
headers[1] <- "Measures"
colnames(medianincom2011b2014) <-headers
medianincom2011b2014$year<-"2014"
lengthofcolumns <-length(colnames(medianincom2011b2014))
medianincom2011b2014<-medianincom2011b2014[c(lengthofcolumns,1:lengthofcolumns-1)]

#remove intermediate csv files
file.remove("medianincom2011b2011.csv", 
            "medianincom2011b2013.csv", 
            "medianincom2011b2014.csv")
